...
def main():
  ...
  if month in months:
    if month=="December" and day>=22 and day<=31or month=="January" and day<=19:
      print("Your zodiac sign is Capricorn")
    elif month=="January" and day>=20 and day<=31 or month=="February" and day<=18:
      print("Your zodiac sign is Aquarius")
    elif month=="February" and day>=19 and day<=28 or month=="March" and day<=20:
      print("Your zodiac sign is Pisces")
    elif month=="March" and day>=21 and day<=31 or month=="April" and day<=19:
      print("Your zodiac sign is Aries")
    elif month=="April" and day>=20 and day<=30 or month=="May" and day<=20:
     print("Your zodiac sign is Taurus")
    elif month=="May" and day>=21 and day<=31 or month=="June" and day<=20:
      print("Your zodiac sign is Gemini")
    elif month=="June" and day>=21 and day<=30 or month=="July" and day<=22:
